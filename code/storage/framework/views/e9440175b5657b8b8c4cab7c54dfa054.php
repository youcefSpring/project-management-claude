        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    ...
                    <?php echo e(__('app.projects.discussion')); ?>
            ...
            <div class="card-body">
                ...
                <div class="card bg-light mb-4">
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('projects.notes.store', $project)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                                <label for="content" class="form-label"><?php echo e(__('app.comments.add_comment')); ?></label>
                                <textarea class="form-control" id="content" name="content" rows="3"
                                          placeholder="<?php echo e(__('app.notes.write_comment_placeholder')); ?>"></textarea>
                            </div>
                ...
                <!-- Discussion List -->
                <?php if($project->notes && $project->notes->count() > 0): ?>
                    <div class="discussion-list">
                        <?php $__currentLoopData = $project->notes->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        ...
                                        <?php if($note->canBeDeletedBy(auth()->user())): ?>
                                            <form method="POST" action="<?php echo e(route('projects.notes.destroy', $note)); ?>" 
                                                  onsubmit="return confirm('<?php echo e(__('app.messages.confirm_delete')); ?>')">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <div class="row g-2">
                                                <?php $__currentLoopData = $note->image_attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-md-2 col-4">
                                                        <a href="<?php echo e($attachment['versions']['original']['url'] ?? '#'); ?>" target="_blank">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/projects/show.blade.php ENDPATH**/ ?>