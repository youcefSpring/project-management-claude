...
<section class="py-5">
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <form method="GET" action="<?php echo e(route('courses.index')); ?>" class="d-flex gap-2">
                    <input type="text"
                           name="search"
                           class="form-control"
            ...
            <div class="col-md-4 text-md-end">
                <span class="text-muted"><?php echo e($courses->total()); ?> course(s) found</span>
            </div>
        </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <?php if($course->start_date && $course->end_date): ?>
                                        <small class="text-muted">
                                            ...
                                            <?php echo e($course->start_date->format('M j, Y')); ?> - <?php echo e($course->end_date->format('M j, Y')); ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="<?php echo e(route('courses.show', $course->slug)); ?>" class="btn btn-primary btn-sm">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/courses/index.blade.php ENDPATH**/ ?>