...
<div class="row">
    <div class="col-md-8">
        ...
        <?php if($user->isManager()): ?>
            <div class="card mt-4">
                <div class="card-header">
                    <h5 class="mb-0">
                        <?php echo e(__('Managed Projects')); ?>
                ...
                <div class="card-body">
                                    ...
                                    <div class="card border-start border-<?php echo e($project->status === 'active' ? 'success' : ($project->status === 'completed' ? 'primary' : 'warning')); ?> border-3">
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <small class="text-muted"><?php echo e($project->tasks->count()); ?> <?php echo e(__('tasks')); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php else: ?>
                        <p class="text-muted text-center py-3"><?php echo e(__('No projects managed yet.')); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        <?php endif; ?>
                        ...
                        <?php if($user->assignedTasks->count() > 10): ?>
                            <div class="text-center">
                                <a href="<?php echo e(route('tasks.index', ['assigned_to' => $user->id])); ?>" class="btn btn-outline-primary">
                                    <?php echo e(__('View All Tasks')); ?>

                                </a>
                            </div>
                        <?php endif; ?>
                    <?php else: ?>
                        <p class="text-muted text-center py-3"><?php echo e(__('No tasks assigned yet.')); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="card mt-4">
            <div class="card-header">
                <h5 class="mb-0"><?php echo e(__('Recent Activity')); ?></h5>
            </div>
            <div class="card-body">
                ...
                <?php else: ?>
                    <p class="text-muted text-center py-3"><?php echo e(__('No recent activity.')); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <?php if($user->isManager()): ?>
                    <div class="stat-item">
                        ...
                        <div class="stat-label"><?php echo e(__('Projects Managed')); ?></div>
                    </div>
                <?php endif; ?>
                ...
                <?php if($user->canWorkOnTasks()): ?>
                    <div class="stat-item">
                        ...
                        <div class="stat-label"><?php echo e(__('Tasks Assigned')); ?></div>
                    </div>

                    <div class="stat-item">
                        <div class="stat-value"><?php echo e($stats['completed_tasks']); ?></div>
                        <div class="stat-label"><?php echo e(__('Tasks Completed')); ?></div>
                    </div>

                    <div class="stat-item">
                        <div class="stat-value"><?php echo e(number_format($stats['total_time_logged'], 1)); ?>h</div>
                        <div class="stat-label"><?php echo e(__('Time Logged')); ?></div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/users/show.blade.php ENDPATH**/ ?>