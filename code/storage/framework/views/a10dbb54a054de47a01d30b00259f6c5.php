...
<div class="card mb-3 task-card hover-shadow" data-task-id="<?php echo e($task->id); ?>">
    <div class="card-body">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="dropdown-item" href="<?php echo e(route('timesheet.create')); ?>?task_id=<?php echo e($task->id); ?>">
                            <i class="bi bi-clock me-2"></i><?php echo e(__('Log Time')); ?>
        ...
        <div class="d-flex align-items-center">
            <i class="bi bi-calendar me-1 <?php echo e($task->due_date->isPast() && $task->status !== 'fait' ? 'text-danger' : 'text-muted'); ?>"></i>
            <small class="<?php echo e($task->due_date->isPast() && $task->status !== 'fait' ? 'text-danger fw-bold' : 'text-muted'); ?>">
                <?php echo e($task->due_date->format('M d, Y')); ?>

            </small>
            <?php if($task->due_date->isPast() && $task->status !== 'fait'): ?>
                <i class="bi bi-exclamation-triangle text-danger ms-1" title="<?php echo e(__('Overdue')); ?>"></i>
            <?php endif; ?>
        </div>
        <?php endif; ?>
...
</div><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/components/task-card.blade.php ENDPATH**/ ?>