            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('contact.store')); ?>" id="contactForm">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="collaboration" <?php echo e(old('subject') == 'collaboration' ? 'selected' : ''); ?>>Collaboration Opportunity</option>
                                        <option value="course_question" <?php echo e(old('subject') == 'course_question' ? 'selected' : ''); ?>>Course Question</option>
                                        <option value="research_inquiry" <?php echo e(old('subject') == 'research_inquiry' ? 'selected' : ''); ?>>Research Inquiry</option>
                                        <option value="speaking_engagement" <?php echo e(old('subject') == 'speaking_engagement' ? 'selected' : ''); ?>>Speaking Engagement</option>
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="<?php echo e(route('courses.index')); ?>" class="list-group-item list-group-item-action border-0 px-0">
                                <i class="bi bi-book me-2"></i>View Courses
                            </a>
                            <a href="<?php echo e(route('projects.index')); ?>" class="list-group-item list-group-item-action border-0 px-0">
                                <i class="bi bi-code-slash me-2"></i>Browse Projects
                            </a>
                            <a href="<?php echo e(route('publications.index')); ?>" class="list-group-item list-group-item-action border-0 px-0">
                                <i class="bi bi-journal-text me-2"></i>Read Publications
                            </a>
                            <a href="<?php echo e(route('blog.index')); ?>" class="list-group-item list-group-item-action border-0 px-0">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/Terminé/project-management-claude/code/resources/views/contact/show.blade.php ENDPATH**/ ?>