                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input additional-role" type="checkbox"
                                                   ...
                                                   <?php echo e(in_array($role, old('additional_roles', $userAdditionalRoles)) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        <div class="form-text"><?php echo e(__('Current additional roles: ')); ?>

                            <?php if(count($userAdditionalRoles) > 0): ?>
                                <?php echo e(implode(', ', array_map(fn($role) => $roleLabels[$role], $userAdditionalRoles))); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <hr>
                    <h6><?php echo e(__('app.profile_settings.change_password')); ?> <small class="text-muted">(<?php echo e(__('app.users.password_leave_blank')); ?>)</small></h6>
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/Terminé/project-management-claude/code/resources/views/users/edit.blade.php ENDPATH**/ ?>