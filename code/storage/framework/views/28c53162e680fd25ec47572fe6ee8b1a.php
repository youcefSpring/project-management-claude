        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="row g-2">
                    ...
                    <?php else: ?>
                        <div class="col-12">
                            <p class="text-muted small mb-0">No tags available. <a href="<?php echo e(route('admin.tags.create')); ?>">Create tags</a> to organize your projects.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/admin/projects/create.blade.php ENDPATH**/ ?>