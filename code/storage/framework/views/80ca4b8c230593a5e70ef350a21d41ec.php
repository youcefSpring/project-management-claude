...
<head>
    ...
    <title>Admin - <?php echo e(config('app.name', 'Teacher Portfolio')); ?> <?php if (! empty(trim($__env->yieldContent('title')))): ?> - <?php echo $__env->yieldContent('title'); ?> <?php endif; ?></title>
    ...
    <div class="admin-sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="d-flex align-items-center text-white">
                ...
                <span class="fw-bold" id="sidebar-title"><?php echo e(__('app.Administration')); ?></span>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('profile.index')); ?>" class="nav-link <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
                ...
                <span><?php echo e(__('app.Profile')); ?></span>
            </a>
        ...
        <div class="admin-header">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="mb-0"><?php echo $__env->yieldContent('page-title', __('app.Dashboard')); ?></h4>
                </div>
                <div class="d-flex align-items-center">
                    <span class="text-muted me-3"><?php echo e(__('app.welcome')); ?>, <?php echo e(Auth::user()->name); ?></span>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?php echo e(route('profile.settings')); ?>">
                                <i class="bi bi-person-gear me-2"></i><?php echo e(__('app.settings')); ?>

                            </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('home')); ?>">
                                <i class="bi bi-eye me-2"></i><?php echo e(__('app.view_site')); ?>
...
<?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/Terminé/project-management-claude/code/resources/views/layouts/admin.blade.php ENDPATH**/ ?>