                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-3 col-6 mb-3">
                        <div class="text-white-50">
                            ...
                            <div class="mt-2">
                                <strong class="text-white d-block"><?php echo e($project->start_date->format('M Y')); ?></strong>
                                <small>Started</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow-sm border-0 mb-4 sticky-top" style="top: 2rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-muted"><?php echo e($project->start_date->format('F j, Y')); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-muted"><?php echo e($project->end_date->format('F j, Y')); ?></span>
                        </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/public/projects/show.blade.php ENDPATH**/ ?>