...
<p class="subtitle"><?php echo e(__('Sign in to your account to continue')); ?></p>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="d-grid mb-3">
        <button type="submit" class="btn btn-primary" id="login-btn">
            <span class="login-text"><?php echo e(__('Sign In')); ?></span>
    ...
    <div class="text-center">
        <p class="mb-0">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-link"><?php echo e(__('Sign up')); ?></a>
        </p>
    </div>
</form>
        ...
        axios.post(form.action, formData)
            .then(response => {
                if (response.data.success) {
                    showSuccess(response.data.message || '<?php echo e(__("Login successful! Redirecting...")); ?>');
                    ...
                    showError(response.data.message || '<?php echo e(__("Login failed. Please try again.")); ?>');
                    resetForm();
                }
            })
            .catch(error => {
                if (error.response?.status === 422) {
                    ...
                    showError('<?php echo e(__("Invalid credentials. Please check your email and password.")); ?>');
                } else {
