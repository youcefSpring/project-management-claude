...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('app.auth.login_title')); ?> - <?php echo e(config('app.name', 'Gestion de Projets')); ?></title>
                ...
                <div class="col-md-6">
                    <div class="auth-brand">
                        <div>
                            ...
                            <h1><?php echo e(config('app.name', 'PM App')); ?></h1>
                            <p><?php echo e(__('Professional Project Management Solution')); ?></p>

                            <ul class="features list-unstyled">
                                <li>
                                    <i class="bi bi-check-circle-fill"></i>
                                    <?php echo e(__('Project & Task Management')); ?>

                                </li>
                                <li>
                                    <i class="bi bi-check-circle-fill"></i>
                                    <?php echo e(__('Time Tracking & Reporting')); ?>

                                </li>
                                <li>
                                    <i class="bi bi-check-circle-fill"></i>
                                    <?php echo e(__('Team Collaboration')); ?>

                                </li>
                                <li>
                                    <i class="bi bi-check-circle-fill"></i>
                                    <?php echo e(__('Multilingual Support')); ?>

                                </li>
                                <li>
                                    <i class="bi bi-check-circle-fill"></i>
                                    <?php echo e(__('Real-time Updates')); ?>
...
<?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/Terminé/project-management-claude/code/resources/views/layouts/auth.blade.php ENDPATH**/ ?>