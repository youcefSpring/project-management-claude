            ...
            <div class="col-lg-8 mx-auto">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('courses.index')); ?>" class="text-white text-decoration-none">Courses</a>
                        </li>
                        <li class="breadcrumb-item active text-white-50" aria-current="page">
                            <?php echo e($course->course_code ?? 'Course'); ?>
                ...
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <span class="badge bg-light text-dark"><?php echo e($course->course_code ?? 'COURSE 101'); ?></span>
                    <?php if($course->level): ?>
                        <span class="badge bg-warning text-dark"><?php echo e(ucfirst($course->level)); ?></span>
                    <?php endif; ?>
                ...
                <!-- Course Title -->
                <h1 class="display-5 fw-bold mb-4"><?php echo e($course->title ?? 'Course Title'); ?></h1>

                <!-- Course Summary -->
                <?php if($course->summary ?? false): ?>
                    <p class="lead mb-4"><?php echo e($course->summary); ?></p>
                <?php endif; ?>
                ...
                <div class="row text-center">
                    <div class="col-md-3 col-6 mb-3">
                        <div class="text-white-50">
                            ...
                            <div class="mt-2">
                                <strong class="text-white d-block"><?php echo e($course->credits ?? 3); ?></strong>
                                <small>Credits</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-6 mb-3">
                        <div class="text-white-50">
                            ...
                            <div class="mt-2">
                                <strong class="text-white d-block"><?php echo e(ucfirst($course->semester)); ?></strong>
                                <small><?php echo e($course->year); ?></small>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                    <?php if($course->enrollment_count): ?>
                    <div class="col-md-3 col-6 mb-3">
                        <div class="text-white-50">
                            <i class="bi bi-people" style="font-size: 1.5rem;"></i>
                            <div class="mt-2">
                                <strong class="text-white d-block"><?php echo e($course->enrollment_count); ?></strong>
                    ...
                    <div class="col-md-3 col-6 mb-3">
                        <div class="text-white-50">
                            ...
                            <div class="mt-2">
                                <strong class="text-white d-block"><?php echo e($course->meeting_times); ?></strong>
...
<section class="py-5 bg-white">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Course Image -->
                <?php if($course->image ?? false): ?>
                <div class="mb-5">
                    <img src="<?php echo e(Storage::url($course->image)); ?>"
                         class="img-fluid rounded shadow-sm" alt="<?php echo e($course->title); ?>"
                ...
                <div class="card shadow-sm border-0 mb-5">
                    ...
                    <div class="card-body p-4">
                        <?php if($course->description ?? false): ?>
                ...
                <!-- Learning Objectives -->
                <?php if($course->learning_objectives ?? false): ?>
                <div class="card shadow-sm border-0 mb-5">
                    ...
                    <div class="card-body p-4">
                        <div class="learning-objectives">
                            <?php echo $course->learning_objectives; ?>
                ...
                <!-- Assessment Methods -->
                <?php if($course->assessment_methods ?? false): ?>
                <div class="card shadow-sm border-0 mb-5">
                    ...
                    <div class="card-body p-4">
                        <div class="assessment-methods">
                            <?php echo $course->assessment_methods; ?>
                ...
                <!-- Resources -->
                <?php if($course->required_textbooks || $course->recommended_readings): ?>
                <div class="card shadow-sm border-0 mb-5">
                    <div class="card-header bg-secondary text-white">
                        <h4 class="mb-0"><i class="bi bi-book me-2"></i>Course Resources</h4>
                    </div>
                    <div class="card-body p-4">
                        <?php if($course->required_textbooks): ?>
                            <h6>Required Textbooks</h6>
                            <div class="mb-3">
                                <?php echo nl2br(e($course->required_textbooks)); ?>

                            </div>
                        <?php endif; ?>

                        <?php if($course->recommended_readings): ?>
                            <h6>Recommended Readings</h6>
                            <div>
                                <?php echo nl2br(e($course->recommended_readings)); ?>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm border-0 mb-4 sticky-top" style="top: 2rem;">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <span class="text-muted"><?php echo e($course->course_code ?? 'COURSE 101'); ?></span>
                        </div>

                        <div class="mb-3">
                            <strong>Credits:</strong><br>
                            <span class="text-muted"><?php echo e($course->credits ?? 3); ?> credit hours</span>
                        </div>

                        <?php if($course->level): ?>
                        <div class="mb-3">
                            <strong>Level:</strong><br>
                            <span class="text-muted"><?php echo e(ucfirst($course->level)); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-muted"><?php echo e(ucfirst($course->semester)); ?> <?php echo e($course->year); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-muted"><?php echo e($course->meeting_times); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-muted"><?php echo e($course->location); ?></span>
                        </div>
                        <?php endif; ?>

                        <?php if($course->enrollment_limit): ?>
                        <div class="mb-3">
                            <strong>Enrollment Limit:</strong><br>
                            <span class="text-muted"><?php echo e($course->enrollment_limit); ?> students</span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-muted"><?php echo e($course->prerequisites); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="card-body text-center">
                        <?php if($teacher->avatar ?? false): ?>
                            <img src="<?php echo e(Storage::url($teacher->avatar)); ?>"
                                 alt="<?php echo e($teacher->name ?? 'Instructor'); ?>"
                ...
                <!-- Course Materials -->
                <?php if($course->syllabus_file || $course->course_materials): ?>
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-info text-white">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($course->course_materials): ?>
                            <?php $__currentLoopData = json_decode($course->course_materials, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-2">
                                    <a href="<?php echo e(Storage::url($material['file'])); ?>"
                                       class="text-decoration-none" target="_blank">
                                        <i class="bi bi-file-earmark text-primary me-2"></i><?php echo e($material['name']); ?>
                ...
                <!-- Related Courses -->
                <?php if(isset($relatedCourses) && $relatedCourses->count() > 0): ?>
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-warning text-white">
                        <h5 class="mb-0"><i class="bi bi-collection me-2"></i>Related Courses</h5>
                    </div>
                    <div class="card-body p-0">
                        <?php $__currentLoopData = $relatedCourses->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedCourse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                                <h6 class="mb-2">
                                    <a href="<?php echo e(route('courses.show', $relatedCourse->slug)); ?>"
                                       class="text-decoration-none">
                                        <?php echo e($relatedCourse->course_code); ?> - <?php echo e($relatedCourse->title); ?>

                                    </a>
                                </h6>
                                <small class="text-muted">
                                    <?php echo e($relatedCourse->credits); ?> Credits • <?php echo e(ucfirst($relatedCourse->level)); ?>
...
<section class="py-4 bg-light">
    <div class="container">
        <div class="row">
            <?php if(isset($previousCourse)): ?>
                <div class="col-md-6 mb-3">
                    <div class="card h-100 border-0">
                        <div class="card-body">
                            <small class="text-muted">Previous Course</small>
                            <h6 class="mt-2">
                                <a href="<?php echo e(route('courses.show', $previousCourse->slug)); ?>"
                                   class="text-decoration-none">
                                    <i class="bi bi-arrow-left me-1"></i><?php echo e($previousCourse->course_code); ?> - <?php echo e($previousCourse->title); ?>
            ...
            <?php if(isset($nextCourse)): ?>
                <div class="col-md-6 mb-3">
                    <div class="card h-100 border-0">
                        <div class="card-body text-end">
                            <small class="text-muted">Next Course</small>
                            <h6 class="mt-2">
                                <a href="<?php echo e(route('courses.show', $nextCourse->slug)); ?>"
                                   class="text-decoration-none">
                                    <?php echo e($nextCourse->course_code); ?> - <?php echo e($nextCourse->title); ?><i class="bi bi-arrow-right ms-1"></i>
                                </a>
                            </h6>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/public/courses/show.blade.php ENDPATH**/ ?>