    ...
    <div class="admin-content" id="content">
        ...
        <div class="admin-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <span class="text-muted me-3">Welcome, <?php echo e(Auth::user()->name); ?></span>
                    <div class="dropdown">
...
</html><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/layouts/admin.blade.php ENDPATH**/ ?>