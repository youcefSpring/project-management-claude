                            ...
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                ...
                                <div class="text-end">
                                    <?php if($project->start_date): ?>
                                        <small class="text-muted d-block"><?php echo e($project->start_date->format('Y')); ?></small>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/public/projects/index.blade.php ENDPATH**/ ?>