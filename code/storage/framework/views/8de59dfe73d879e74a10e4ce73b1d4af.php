...
<div class="row g-3 mb-4">
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                <h3 class="text-primary"><?php echo e($statusCounts['unread'] ?? 0); ?></h3>
    ...
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                <h3 class="text-success"><?php echo e($statusCounts['read'] ?? 0); ?></h3>
    ...
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                <h3 class="text-info"><?php echo e($statusCounts['replied'] ?? 0); ?></h3>
    ...
    <div class="col-md-3">
        <div class="card text-center">
            <div class="card-body">
                <h3 class="text-danger"><?php echo e($statusCounts['spam'] ?? 0); ?></h3>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('admin.contact.index')); ?>" class="row g-3">
            <div class="col-md-4">
...
<div class="card">
    <div class="card-header bg-white">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">
                Messages (<?php echo e($messages->total()); ?>)
            </h5>
                ...
                <tbody>
                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="<?php echo e($message->status === 'unread' ? 'table-warning' : ''); ?>">
                            ...
                            <td>
                                <div class="d-flex align-items-start">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <a href="<?php echo e(route('admin.contact.show', $message)); ?>" class="text-decoration-none">
                                        ...
                                        <p class="text-muted small mb-1">
                                            <i class="bi bi-envelope me-1"></i><?php echo e($message->email); ?>
                            ...
                            <td>
                                <span class="fw-medium"><?php echo e($message->subject); ?></span>
                            </td>
                            <td>
                                <?php if($message->status === 'unread'): ?>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="<?php echo e(route('admin.contact.show', $message)); ?>">
                                        ...
                                        <?php if($message->status === 'unread'): ?>
                                            <li>
                                                <button class="dropdown-item" onclick="updateStatus(<?php echo e($message->id); ?>, 'read')">
                                        ...
                                        <?php if($message->status !== 'replied'): ?>
                                            <li>
                                                <button class="dropdown-item" onclick="updateStatus(<?php echo e($message->id); ?>, 'replied')">
                                                    <i class="bi bi-reply me-2"></i>Mark as Replied
                                                </button>
                                            </li>
                                        <?php endif; ?>
                                        <?php if($message->status !== 'spam'): ?>
                                            <li>
                                                <button class="dropdown-item text-warning" onclick="updateStatus(<?php echo e($message->id); ?>, 'spam')">
                                        ...
                                        <li><hr class="dropdown-divider"></li>
                                        <li>
                                            <form method="POST" action="<?php echo e(route('admin.contact.destroy', $message)); ?>" class="d-inline">
                                                <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        <div class="card-body text-center py-5">
            ...
            <?php if(request()->hasAny(['search', 'status', 'date_range'])): ?>
                <h5 class="text-muted">No messages found</h5>
                <p class="text-muted mb-3">No messages match your current filters.</p>
                <a href="<?php echo e(route('admin.contact.index')); ?>" class="btn btn-outline-primary">
...
<script>
    ...
    function markAllAsRead() {
        if (confirm('Are you sure you want to mark all messages as read?')) {
            ...
            window.location.href = '<?php echo e(route("admin.contact.index")); ?>?mark_all_read=1';
        }
    }
    ...
    function executeBulkAction() {
        ...
        if (action === 'delete') {
            form.action = '<?php echo e(route("admin.contact.bulk-delete")); ?>';
        } else {
            form.action = '<?php echo e(route("admin.contact.bulk-status")); ?>';
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/Terminé/project-management-claude/code/resources/views/admin/contact/index.blade.php ENDPATH**/ ?>