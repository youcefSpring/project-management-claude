                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <?php if($project->start_date): ?>
                                <small class="text-muted"><?php echo e(is_string($project->start_date) ? \Carbon\Carbon::parse($project->start_date)->format('Y') : $project->start_date->format('Y')); ?></small>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/Terminé/project-management-claude/code/resources/views/public/home.blade.php ENDPATH**/ ?>