            ...
            <div class="card-body">
                ...
                <?php if($project->start_date): ?>
                    <div class="mb-3">
                        ...
                        <div><?php echo e($project->start_date->format('F d, Y')); ?></div>
                    </div>
                <?php endif; ?>
                ...
                <?php if($project->end_date): ?>
                    <div class="mb-3">
                        ...
                        <div><?php echo e($project->end_date->format('F d, Y')); ?></div>
                    </div>
                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/admin/projects/show.blade.php ENDPATH**/ ?>