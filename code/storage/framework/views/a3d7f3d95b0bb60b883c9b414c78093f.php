...
<p class="subtitle"><?php echo e(__('Join us to start managing your projects efficiently')); ?></p>
...
unset($__errorArgs, $__bag); ?>
    ...
    <!-- Language Preference -->
    <div class="mb-3">
        <label for="language" class="form-label"><?php echo e(__('Preferred Language')); ?></label>
        <div class="input-group">
            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>"
            ...
            <label class="form-check-label" for="terms">
                ...
                <a href="#" class="btn-link"><?php echo e(__('Terms of Service')); ?></a>
                <?php echo e(__('and')); ?>

                <a href="#" class="btn-link"><?php echo e(__('Privacy Policy')); ?></a>
            </label>
        </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="d-grid mb-3">
        <button type="submit" class="btn btn-primary" id="register-btn">
            <span class="register-text"><?php echo e(__('Create Account')); ?></span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/charikatec/Desktop/my docs/Laravel Apps/project-management-claude/code/resources/views/auth/register.blade.php ENDPATH**/ ?>